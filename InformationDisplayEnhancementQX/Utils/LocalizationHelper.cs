...
namespace InformationDisplayEnhancementQX.Utils
{
    ...
    {
        public const string KeyPrefix = "InfoDisplayEnhancementQX.";

        public static Dictionary<string, string> OriginalLocalizationDict { get; } = new Dictionary<string, string>()
        {
            [$"{KeyPrefix}ModSettingButton"] = "[Mod]InfoDisplayEnhancement",
            [$"{KeyPrefix}Option_Off"] = "Close",
            [$"{KeyPrefix}Option_On"] = "Open",
            [GetDropdownOptionLabelKey(DisplayHealthValue.KEY)] = "Display Health Value",
            [GetDropdownOptionLabelKey(DisplayCharacterName.KEY)] = "Display Character Name",
            [GetDropdownOptionLabelKey(DecimalPlacesOfHealthValue.KEY)] = "Decimal Places of Health Value",
            [$"{KeyPrefix}Option_AllCharacter"] = "All Characters",
