...
{
    public class DisplayCharacterName : OptionsProviderBase
    {
        public const string KEY = LocalizationHelper.KeyPrefix + nameof(DisplayCharacterName);
        ...
        {
            int index = ModSettingCenter.ShowCharacterName ? 1 : 0;
            Set(index);
        }

        public override string GetCurrentOption()
        {
            return ModSettingCenter.ShowCharacterName ? Option_1.ToPlainText() : Option_0.ToPlainText();
        }
        ...
        public override void Set(int index)
        {
            ...
            {
                case 0:
                    ModSettingCenter.ShowCharacterName = false;
                    break;
                case 1:
                    ModSettingCenter.ShowCharacterName = true;
                    break;
            }
